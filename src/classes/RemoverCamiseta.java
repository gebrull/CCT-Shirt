...
public class RemoverCamiseta {
	...
	RemoverCamiseta() {
		...
		menu.add(sobre);
				...
				comando = new JLabel("Digite o código da camisa que deseja remover");
				comando.setBounds(15, 40, 300, 20);
	...
	private class TrataEventos implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource() == vai){
				JOptionPane.showMessageDialog(null, "Camiseta removida");
